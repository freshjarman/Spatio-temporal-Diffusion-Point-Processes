...
# --timesteps 必须对应正确
$env:KMP_DUPLICATE_LIB_OK="TRUE"; python app_uq_ensemble_test.py --dataset Earthquake --mode test --model_type rf --timesteps 1000 --n_ensemble 10 --samplingsteps 50 --batch_size 64 --cuda_id 0