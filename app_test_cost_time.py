...
if __name__ == "__main__":
    ...
    # MODEL_PATH = './ModelSave/dataset_Earthquake_timesteps_500_2025-04-28-16h/model_1020.pkl'  # for DSTPP Earthquake
    ...
    for run_idx in range(1):
        ...
        with torch.no_grad():
            ...
            for batch in testloader:
                ...
                print('TEST_1个batch【64】的编码耗时：', encode_end_time - start_time)
                ...
                end_time = time.time()
                print('TEST_1个batch【64】的采样耗时：', end_time - encode_end_time)
